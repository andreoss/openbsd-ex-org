...
The result image will be bootable on UEFI machines.
...
*** Patch installation image in order to enable serial port (Optional)
...
** Setup UEFI Bios
*** UEFI Bios image
Installing [[https://github.com/tianocore/tianocore.github.io/wiki/OVMF][UEFI Bios]] for QEMU. This BIOS does not support CD, this is why we are using a disk image.
